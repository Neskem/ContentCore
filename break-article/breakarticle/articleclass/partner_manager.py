...
def get_sitemap_url():
    try:
       ...
       if r.status_code == 200:
            ...
            logger.debug("generate_url_hash_validate_partner_ids, json_resp: {}".format(json_resp))
            return sitemap_data_list
    except:
        logger.debug("Can't search  sitemap url list from partner system or system has happen error.")
