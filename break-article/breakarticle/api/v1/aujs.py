...
from breakarticle.articleclass.orm_article import init_url_info, update_partner_id_urlinfo, init_service_info
from breakarticle.articleclass.orm_article import exist_url_hash_urlinfo, update_service_info, init_task_info
from breakarticle.articleclass.orm_article import exist_url_hash_serviceinfo, exist_url_hash_taskinfo, update_task_info
from breakarticle.articleclass.orm_article import exist_finished_taskinfo
from breakarticle.articleclass.decorators import generate_urlhash_validate_partnerids
...
def task_to_sync(url, url_hash, domain, partner_id_list=None):
    ...
    if taskinfo_validate:
        ...
        if taskinfo_finished_validate is "finished" or "pending":
            ...
            from breakarticle.tasks import send_task_content_core
...
def task_to_async(url, url_hash, domain, partner_id_list=None):
    ...
    from breakarticle.tasks import sitemap_update_content
    test_priority = 5
