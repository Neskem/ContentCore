...
def send_task_content_core(task_dict):
    ...
    if check_task_status:
        ...
        logging.info(
            'Celery_task: send_task_content_core, task_json: {}'.format(task_json))
    return True
        ...
        if r.status_code == 200:
            ...
            for urltag in main_menu:
                ...
                if urlinfo_validate is False:
                    init_task_obj = TaskInitialization(
                        task_type, url, url_hash, sitemap_url_domain, priority, sitemap_partner_id)
